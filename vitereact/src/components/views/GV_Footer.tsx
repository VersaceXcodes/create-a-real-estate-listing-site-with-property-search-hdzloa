...
const GV_Footer: React.FC = () => {
  ...
  const navigateToInfoPage = (page: string): void => {
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <nav className="flex flex-wrap justify-center" aria-label="Footer Navigation">
              <Link
                ...
                onClick={() => navigateToInfoPage("about")}
              >
                About
              </Link>
              <Link
                to="/contact"
                className="mx-2 hover:underline"
                onClick={() => navigateToInfoPage("contact")}
              >
                Contact
              </Link>
              <Link
                to="/terms"
                className="mx-2 hover:underline"
                onClick={() => navigateToInfoPage("terms of service")}
              >
                Terms of Service
              </Link>
              <Link
                to="/privacy"
                className="mx-2 hover:underline"
                onClick={() => navigateToInfoPage("privacy policy")}
              >
                Privacy Policy
              </Link>
            </nav>
            <div className="flex justify-center mt-4 md:mt-0">
              <a
                href="https://facebook.com/estatefinder"
                className="mx-2"
                aria-label="Facebook"
                target="_blank"
              ...
              <a
                href="https://twitter.com/estatefinder"
                className="mx-2"
                aria-label="Twitter"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://instagram.com/estatefinder"
                className="mx-2"
