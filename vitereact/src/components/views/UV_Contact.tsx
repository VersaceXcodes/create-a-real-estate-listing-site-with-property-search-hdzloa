...
const UV_Contact: React.FC = () => {
  ...
  const mutation = useMutation<IContactResponse, AxiosError, IContactForm>(
    (data: IContactForm) => {
      const baseUrl = import.meta.env.VITE_API_BASE_URL || "http://localhost:3000";
      // NOTE: The endpoint '/api/contact' must be implemented on the backend as per view datamap.
    ...
    },
    {
      ...
      onError: (error: AxiosError) => {
        const message = (axios.isAxiosError(error) && error.response?.data?.error) || "Failed to send your message. Please try again later.";
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <p>
              If you have any questions or need more information about EstateFinder, please feel
