...
const UV_About: React.FC = () => {
  ...
  const { data: aboutContent, isLoading } = useQuery<IAboutContent, Error>({
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {aboutContent.team.map((member) => (
                <div key={member.name} className="border rounded p-4 flex flex-col items-center">
                  <img
          ...
          {aboutContent.images && aboutContent.images.length > 0 && (
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {aboutContent.images.map((imgUrl) => (
                  <img
                    key={imgUrl}
                    src={imgUrl}
                    alt="Gallery image"
