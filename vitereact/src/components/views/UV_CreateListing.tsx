    ...
    if (e.target.files) {
      ...
      files.forEach((file) => {
        ...
        setImageUploads((prev) => [
          ...prev,
          { image_url: imageUrl, alt_text: "", display_order: prev.length + 1 },
        ]);
      });
    }
  };
  ...
  const createListingMutation = useMutation(
    ...
    },
    {
      ...
      onError: (error: any) => {
        ...
        add_notification({ type: "error", message: errorMsg });
      },
    }
  );
    ...
    <>
      <div className="container mx-auto p-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="title" className="block font-medium">Property Title</label>
            <input
              id="title"
              type="text"
              name="title"
          ...
          <div>
            <label htmlFor="property_type" className="block font-medium">Property Type</label>
            <input
              id="property_type"
              type="text"
              name="property_type"
          ...
          <div>
            <label htmlFor="zip_code" className="block font-medium">Zip Code</label>
            <input
              id="zip_code"
              type="text"
              name="zip_code"
          ...
          <div>
            <label htmlFor="amenities" className="block font-medium">Amenities (comma separated)</label>
            <input
              id="amenities"
              type="text"
              name="amenities"
          ...
          <div>
            <label htmlFor="area" className="block font-medium">Area (sq ft)</label>
            <input
              id="area"
              type="number"
              name="area"
              ...
              <div className="mt-4 grid grid-cols-2 gap-4">
                {imageUploads.map((img, index) => (
                  <div key={index} className="border p-2">
                    ...
                    />
                    <div>
                      <label htmlFor={`alt_text_${index}`} className="text-sm">Alt Text:</label>
                      <input
                        id={`alt_text_${index}`}
                        type="text"
                        value={img.alt_text}
                    ...
                    <div>
                      <label htmlFor={`display_order_${index}`} className="text-sm">Display Order:</label>
                      <input
